                    ...
                    <form action="<?php echo base_url() ?>libros/registrar" method="post" id="frmLibros" class="row" autocomplete="off" enctype="multipart/form-data">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input id="titulo" class="form-control" type="text" name="titulo" required placeholder="Título del libro">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input id="cantidad" class="form-control" type="text" name="cantidad" min="1"  max="5" required placeholder="Cantidad">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="num_pagina">Cantidad de página</label>
                                <input id="num_pagina" class="form-control" type="number" name="num_pagina" required placeholder="Cantidad Página">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input id="imagen" class="form-control" type="file" name="imagen" required placeholder="Foto">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
