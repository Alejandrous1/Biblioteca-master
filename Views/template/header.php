...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-primary">
        <a class="navbar-brand" href="<?php echo base_url(); ?>admin/listar">Sistema Biblioteca</a>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        <?php if ($_SESSION['rol'] == 1) { ?>
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link active" href="<?php echo base_url(); ?>materia">Genero</a>
                                </nav>
                            </div>
                        <?php } ?>
                        <?php if ($_SESSION['rol'] == 2) { ?>
                            <a class="nav-link active" href="<?php echo base_url(); ?>credito/listar">
                                <div class="sb-nav-link-icon"><i class="fas fa-tasks fa-lg"></i></div>
                                Pedir Libro
                            </a>
                        ...
                        <?php } ?>
                        <a class="nav-link active" href="<?php echo base_url(); ?>Productos">
                                <div class="sb-nav-link-icon"><i class="fas fa-archive fa-lg"></i>
                                </div>
                                Productos
                        </a>
                        <?php if ($_SESSION['rol'] == 1) { ?>
                        ...
                        <?php if ($_SESSION['rol'] == 2) { ?>
                            ...
                            <div class="collapse" id="collapseEst" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link active" target="_blank" href="<?php echo base_url(); ?>credito/pdf">Prestamos</a>
                                    <a class="nav-link active" target="_blank" href="<?php echo base_url(); ?>libros/pdf">Libros</a>
                                </nav>
                            </div>
                        <?php } ?>
